...
const sortAnimals = animals => sort(ascend(prop("name")), animals);
...
export const loadAnimals = dispatch => {
  animalsApi
    .fetchAll()
    .then(animals => dispatch({type: "loadAnimals", animals}));
};

export const addAnimal = (dispatch, animalData) => {
  return animalsApi
    .create(animalData)
    .then(animal => dispatch({type: "addAnimal", animal}));
};

export const updateAnimal = (dispatch, animalData) => {
  return animalsApi
    .update(animalData)
    .then(animal => dispatch({type: "updateAnimal", animal}));
};

export const saveAnimal = (dispatch, animal) => {
  return animal.id
    ? updateAnimal(dispatch, animal)
    : addAnimal(dispatch, animal);
};

export const deleteAnimal = (dispatch, animal) => {
  animalsApi
    .delete(animal)
    .then(() => dispatch({type: "deleteAnimal", animal}));
};
